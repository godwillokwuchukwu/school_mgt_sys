...
file_path = r"c:\Users\Godwill\Downloads\school-management-system-stage2-riverside\school-management-system\warehouse\models.py"
...
class FactAttendance(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['student', 'date'], name='uniq_fact_attendance')
        ]
